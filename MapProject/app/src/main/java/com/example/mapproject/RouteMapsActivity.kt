...
import com.example.mapproject.databinding.ActivityRouteMapsBinding
import com.google.android.gms.maps.model.*
import java.io.IOException

class RouteMapsActivity : FragmentActivity(), OnMapReadyCallback {
        ...
        binding.idSearchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            override fun onQueryTextSubmit(query: String): Boolean {
                ...
                if (location != null || location == "") {
                    ...
                    val geocoder = Geocoder(this@RouteMapsActivity)
                    try {
...
//                markerOptions.icon(BitmapFromVector(this, R.drawable.ic_map_event));
                markerOptions.icon(BitmapFromVector(this, R.drawable.meditating_hanuman))
            } else {
...
//        locationAddress.getAddressFromLocation("BBC Complex Yogichowk Surat", applicationContext, GeoCoderHandler())
//
//        addedMarker.remove()
//
//
